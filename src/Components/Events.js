          ...
          <div id="future-events">
            <div style={{width: '80vw', maxWidth: '800px', margin: '0 auto'}}>
              <h4 style={{ textAlign: "center" }}>
                The easiest way to stay up to date about upcoming shows and
                events is by{" "}
                <a
                  id="IGlink"
              ...
              <h4 style={{ textAlign: "center" }}>
                Check out the Instagram feed below for events coming up soon,
                and a history of events in the past!
              </h4>
            </div>
            {/* <h2>Coming Soon:</h2>
                            <div id='events-list'>
